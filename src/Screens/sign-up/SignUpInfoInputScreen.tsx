          ...
          <View>
            ...
            <View className="mt-2">
              <View className="flex flex-row gap-x-2">
                <CustomButton twClass="bg-slate-200 w-[45%]">아빠</CustomButton>
                <CustomButton twClass="bg-slate-200 w-[45%]">엄마</CustomButton>
              </View>
              <View className="flex flex-row gap-x-2">
                <CustomButton twClass="bg-slate-200 w-[45%]">아들</CustomButton>
